...
export const getPublicLocationVouchers = asyncHandler(async (req: Request, res: Response) => sendSuccess(res, 200, await voucherService.getPublicLocationVouchers(param(req.params.locationId))));
export const getPublicVoucher = asyncHandler(async (req: Request, res: Response) => sendSuccess(res, 200, await voucherService.getPublicVoucher(param(req.params.voucherId))));
